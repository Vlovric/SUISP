...
Kao i ostatak implementacije, i ovaj mehanizam je u potpunosti kompatibilan sa svim operacijskim sustavima zbog korištenja \texit{QLocalSocket} i \texit{QLocalServer} biblioteka koje koriste \textit{unix domain socket} na Linux/macOS sustavima i \textit{imenovane cjevovode} na Windows sustavima.
