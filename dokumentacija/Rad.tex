...
\vrstaRada{\seminar}
\predmet{Strateško upravljanje informacijskom sigurnošću i privatnošću}
\title{Python Client-Side Encrypted File Vault \& Audit Trails}
...
\acrodef{SUISP}{Strateško upravljanje informacijskom sigurnošću i privatnošću}
